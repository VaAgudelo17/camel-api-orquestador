...
public class GetStepApiController implements GetStepApi {
    ...
    @EndpointInject(uri="direct:get-step-two")
    ...
    private boolean isStepValid(JsonApiBodyRequest body) {
    	return body.getData().get(0).getStep().equalsIgnoreCase("2");
    }
    ...
    private List<JsonApiBodyResponseErrors> createResponseErrors(JsonApiBodyRequest body) {
    	...
    	errorDetail.setDetail("Step: " + body.getData().get(0).getStep() + " not supported - Expected: 2");
