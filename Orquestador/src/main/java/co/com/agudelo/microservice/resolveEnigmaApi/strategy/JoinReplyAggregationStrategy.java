package co.com.agudelo.microservice.resolveEnigmaApi.strategy;
...
public class JoinReplyAggregationStrategy implements AggregationStrategy {
	...
	public Exchange aggregate(Exchange exchange1, Exchange exchange2) {
		if (exchange1 == null) {
			...
			} else if (!code1.equalsIgnoreCase("0000")) {
				exchange1.setProperty("Error", code1);
				exchange1.setProperty("descError", desc1);
			}
